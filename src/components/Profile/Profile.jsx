  ...
  <div className={css.profile}>
    ...
    <ul className={css.profile__list}>
      <li className={css.profile__item}>
        <span
          className={`${css["profile__item-followers"]} ${css["soc-description"]}`}
        >
          Followers
        </span>
        <span
          className={`${css["profile__item-followers-stats"]} ${css.stats}`}
        >
          {stats.followers}
        </span>
      </li>
      <li className={css.profile__item}>
        <span
          className={`${css["profile__item-views"]} ${css["soc-description"]}`}
        >
          Views
        </span>
      ...
      <li className={css.profile__item}>
        <span
          className={`${css["profile__item-likes"]} ${css["soc-description"]}`}
        >
          Likes
        </span>
